...
export const Header: React.FC = () => {
  ...
  return (
    <header className="flex justify-between items-center h-16 px-4 md:px-6 w-full sticky top-0 z-50 bg-background border-b border-[#2A2A2A] pt-[env(safe-area-inset-top)]">
