  ...
  return (
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          {/* Header */}
          <div style={{ paddingTop: 'max(0.75rem, env(safe-area-inset-top))' }} className="px-4 py-3 border-b border-[#2A2A2A] flex items-center justify-between bg-[#1E1E1E] sticky top-0 z-20">
            <button
