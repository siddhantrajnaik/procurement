...
export const BottomNav: React.FC = () => {
  ...
  return (
    <nav style={{ paddingBottom: 'max(0.5rem, env(safe-area-inset-bottom))' }} className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center h-[72px] glass-nav md:hidden">
      {NAV_ITEMS.map((item) => {
