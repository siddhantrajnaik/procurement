...
function parseCSV(text: string): ParsedRow[] {
  ...
  const hasHeader = first.includes('name') || first.includes('sample');
            ...
            <>
              <div>
                <p className="text-xs text-gray-400 mb-3">
                  CSV format: <span className="text-gray-300 font-mono">name, container, volume, notes</span>
                  <br />
                  Only <span className="font-semibold text-white">name</span> is required. One sample per line.
                </p>
                <button
              ...
              <textarea
                ...
                placeholder={"Silver nitrate\nEthidium bromide, Cryovial, 500 µL\nTrypan blue"}
